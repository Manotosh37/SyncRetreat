import DestinationTemplate, { DestinationConfig } from "./DestinationTemplate";
import { Monitor, Home, Car, Users } from "lucide-react";
...
export default function Ladakh() {
  return <DestinationTemplate config={ladakhConfig} />;
}
