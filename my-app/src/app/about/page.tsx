        ...
        <div className="max-w-4xl mx-auto px-4 md:px-12">
          ...
          <div className="text-slate-600 font-medium space-y-6 leading-relaxed text-[15px]">
            <p>
              ...
              itineraries. They think "good Wi-Fi" means a single consumer
              router in a hotel lobby.
            </p>
            <p>
              SyncRetreat was not built by the tourism industry. It was built by
              software engineers.
            </p>
            <p>
              We understand the technical reality of shipping a product. We know
              what it takes to deploy a full-stack application, manage a DevOps
              pipeline, and coordinate remote servers. More importantly, we know
              that a single dropped connection, an unreliable power grid, or a
              noisy environment can destroy a 10-hour sprint.
            </p>
            <p>
              We built the infrastructure we couldn't find in the world's most
          ...
          <section className="mb-20">
            ...
            <div className="text-slate-600 font-medium space-y-6 leading-relaxed text-[15px]">
              <p>
                We do not sell vacations. We do not accept backpackers, casual
                tourists, or anyone looking to "find themselves."
              </p>
              <p>
                SyncRetreat is a highly vetted, 28-day deep work hub designed
                exclusively for{" "}
                <span className="text-slate-900 font-bold">
                  funded founders, remote professionals, and high-level
                  operators
                </span>{" "}
                who have strict deadlines and require an uncompromising
                environment to execute them.
              </p>
            </div>
